...
public interface TowerRiskRepository extends JpaRepository<TowerRisk, Integer> {
    ...
    public int findCheckCount(String towerId, Integer type);

    @Query("SELECT COUNT(*) FROM TowerRisk f WHERE f.towerID  = ?1 AND f.detectionDataIndex  <> '' ")
    public int findDetectionCount(String towerId);
    ...
    public int findRepairCount(String towerId);
    ...
    public int findCheckCountByLevel(String towerId, List<Integer> level, List<Integer> status);
    ...
    public int findDetectionCountByLevel(String towerId, List<Integer> level, List<Integer> status);
}
