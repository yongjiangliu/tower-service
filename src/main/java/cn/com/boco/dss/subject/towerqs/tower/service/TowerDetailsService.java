...
public class TowerDetailsService {
    ...
    public Object getPageBody(String towerID) {
        ...
        List<TowerRisk> list = riskList.stream().filter(item -> !TowerRiskStatusConstant.RISK_REPAIRED.equals(item.getRiskStatus())).collect(Collectors.toList());
        return list;
    }
    ...
    public CommonData queryCheckData(String param1, int pageIndex, int pageSize, int sortColIndex, SortType sortType) throws Exception {
        return towerDetailsForMysql.queryCheckData(param1, pageIndex, pageSize, sortColIndex, sortType);
    }

    public CommonData queryDetectionData(String param1, int pageIndex, int pageSize, int sortColIndex, SortType sortType) throws Exception {
        return towerDetailsForMysql.queryDetectionData(param1, pageIndex, pageSize, sortColIndex, sortType);
    }

    public CommonData queryRepairData(String param1, int pageIndex, int pageSize, int sortColIndex, SortType sortType) throws Exception {
        return towerDetailsForMysql.queryRepairData(param1, pageIndex, pageSize, sortColIndex, sortType);
    }

    private class PageFoot {
